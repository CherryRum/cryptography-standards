...
该仓库收录了多种密码学标准，主要包括中国的商用密码（SM系列）以及其他常见的密码学标准，如中国密码国家标准、行业标准等。

**项目目的：** 为密码学开发者和研究人员提供便捷的标准文档参考资源，促进密码学技术的学习、研究和实现。

## 包含的标准

### 1. 国密标准（SM系列）

- **SM2**: 公钥密码算法 - 基于椭圆曲线密码（ECC）的非对称加密算法
- **SM3**: 哈希算法 - 密码杂凑算法，用于数据完整性校验
- **SM4**: 对称加密算法 - 分组密码算法，用于数据加密
- **SM9**: 标识密码算法 - 基于身份的密码算法

### 2. 中国密码国家标准和行业标准

详见下表，包含GB/T国家标准和GM/T行业标准的完整对照。
...
<table class="xl65">
 <tbody>
  <tr > 
    <th colspan="4" >中国密码国家标准、行业标准一览表 ——更新时间：2025年12月28日</th>
  </tr> 
        <tr>
...
- **GBT 密码国家标准** - 中国国家密码标准文档（GB/T系列）
- **GMT 密码行业标准（现行）** - 现行有效的密码行业标准（GM/T系列）
- **GMT 密码行业标准（废止）** - 已废止的密码行业标准（供参考）
- **公开文档** - 其他公开的密码相关文档
- **英文标准** - 密码学相关的英文标准文档
...
本仓库的所有标准和文档均来自公开渠道、密评委和开源项目，旨在为学习和研究提供参考。我们尊重所有原作者的版权。

**若有涉及侵权或版权问题，请及时联系，我们将在确认后第一时间删除相关内容。**
...
1. 本项目所有内容仅供学习和研究参考使用
2. 由于技术水平有限，若内容有不准确或不足之处，欢迎提出宝贵意见
3. 使用者应遵守相关法律法规和版权规定
4. 本项目不承担因使用这些资料而产生的任何责任
